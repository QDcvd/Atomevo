<template>
  <div>
    <div class="mag-step">
      <div style="font-weight: bold;margin: 0.5rem">Plants
      ...
      <el-col :lg="24" :xl="12">
        <div class="mag-step-left">
          ...
          <div v-show="!isZip">
            ...
            <UpLoadFile FormatType=".pdb,.mol2" UseType="plants" @GetIDList="GetFileID"></UpLoadFile>
          </div>
        </div>
        <div class="mag-step-left">
          <div>
            ...
            <el-button type="primary" size="small" @click="RunPlants"
    ...
    <el-drawer
      ...
      <excel-edit ModeName="Plants" @HandleExcel="GetExcelData"/>
    </el-drawer>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      RunPlants() {
        ...
        this.$api.GainPlants(data).then(res => {
          // console.log(res)
          this.$notify({
