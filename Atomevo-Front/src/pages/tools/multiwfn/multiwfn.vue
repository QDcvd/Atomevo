<template>
  <div>
        ...
        <div class="mag-step-left">
          <div>
            ...
            <el-button
              ...
              size="small"
              :disabled="
                StepIndex == 1 && ExcelConfig.length > 0 ? false : true
              "
              @click="RunMul"
            >
              {{ $t("btn.run") }}
    ...
    >
      <excel-edit ModeName="Multiwfn" @HandleExcel="GetExcelData" />
    </el-drawer>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState({
      TaksID: (state) => state.TaskIDList.Multiwfn,
    }),
  },
  watch: {
