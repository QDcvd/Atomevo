        ...
        <el-row :gutter="20">
            <el-col :lg="24" :xl="12">
                <div class="mag-step-left">
                    ...
                    <UpLoadFile FormatType=".xvg" UseType="xvg_to_csv" @GetIDList="GetFileID"></UpLoadFile>
                </div>
                <div class="mag-step-left">
                    <div class="diyname">
                    ...
                    <div>
                        <el-button type="primary" size="small" @click="RunXVG2CSV" :disabled="StepIndex==1?false:true">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        TaksID:state => state.TaskIDList.XVG2CSV
      }),
    },
    watch: {
    ...
    methods: {
      ...
      RunXVG2CSV() {
        this.$api.GainXVG2GSV(this.FileID.toString()).then(res => {
          // console.log(res)
          this.$notify({
