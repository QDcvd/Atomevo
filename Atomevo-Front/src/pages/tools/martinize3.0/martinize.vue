<template xmlns="http://www.w3.org/1999/html">
    <div>
        <div class="mag-step">
            <div style="font-weight: bold;margin: 0.5rem">Martinize3.0 Protein
        ...
        <iframe style="margin-left: 10px" width="98%" height="600px" src="https://api.magical.liulianpisa.top/down/SampleFile/martinize3_introduce.txt"></iframe>
    </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      RunMartinize() {
        ...
        this.$api.GainMartinize3(Params).then(res => {
          // console.log(res)
          this.$notify({
