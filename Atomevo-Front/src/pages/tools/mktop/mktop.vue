<template xmlns="http://www.w3.org/1999/html">
    <div>
        <div class="mag-step">
            <div style="font-weight: bold;margin: 0.5rem">Mktop
            ...
            <el-col :lg="24" :xl="12">
                <div class="mag-step-left">
                    ...
                    <div v-show="!isZip">
                        ...
                        <UpLoadFile FormatType=".pdb,.txt" UseType="mktop" @GetIDList="GetFileID" ></UpLoadFile>
                    </div>
                </div>
                <div class="mag-step-left">
                    ...
                    <div style="margin-top: 1rem">
                        <el-button type="primary" size="small" @click="Runmktop" :disabled="StepIndex==1?false:true">
                            {{$t('btn.run')}}
                        </el-button>
                    </div>
                </div>
        ...
        <el-drawer
            ...
            <excel-edit ModeName="Mktop" @HandleExcel="GetExcelData"/>
        </el-drawer>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        TaksID:state => state.TaskIDList.Mktop
      }),
    },
    watch: {
    ...
    methods: {
      ...
      Runmktop() {
        ...
        this.$api.Gainmktop(Params).then(res => {
          // console.log(res)
          this.$notify({
