<template>
    <div>
        <div class="mag-step">
            <div style="font-weight: bold;margin: 0.5rem">DSSP
        ...
        <el-row :gutter="20">
            <el-col :lg="24" :xl="12">
                <div class="mag-step-left">
                    ...
                    <UpLoadFile FormatType=".pdb" UseType="dssp" @GetIDList="GetFileID" :Count="1"></UpLoadFile>
                </div>
                <div class="mag-step-left">
                    ...
                    <div style="margin-top: 1rem">
                        <el-button type="primary" size="small" @click="Rundssp" :disabled="StepIndex==1?false:true">
                            {{$t('btn.run')}}
                        </el-button>
                    </div>
                </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      //任务id
      ...mapState({
        TaksID:state => state.TaskIDList.Dssp
      }),
    },
    watch: {
    ...
    methods: {
      ...
      Rundssp() {
        ...
        this.$api.Gaindssp(Params).then(res => {
          // console.log(res)
          this.$notify({
