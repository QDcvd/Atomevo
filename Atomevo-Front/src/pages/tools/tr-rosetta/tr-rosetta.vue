<template xmlns="http://www.w3.org/1999/html">
  <div>
    <div class="mag-step">
      <div style="font-weight: bold;margin: 0.5rem">trRosetta
      ...
      <el-col :lg="24" :xl="12">
        <div class="mag-step-left">
          ...
          <div v-show="!isZip">
            ...
            <UpLoadFile FormatType=".a3m,.fasta" UseType="trrosetta" @GetIDList="GetFileID" :MaxSize="20"></UpLoadFile>
          </div>
        </div>
        <div class="mag-step-left">
          ...
          <div style="margin-top: 1rem">
            <el-button type="primary" size="small" @click="RuntrRosetta" :disabled="StepIndex==1?false:true">
              {{$t('btn.run')}}
            </el-button>
          </div>
        </div>
    ...
    <el-drawer
      ...
      <excel-edit ModeName="trRosetta" @HandleExcel="GetExcelData"/>
    </el-drawer>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        TaksID:state => state.TaskIDList.trRosetta
      }),
    },
    watch: {
    ...
    methods: {
      ...
      RuntrRosetta() {
        ...
        this.$api.GaintrRosetta(Params).then(res => {
          // console.log(res)
          this.$notify({
