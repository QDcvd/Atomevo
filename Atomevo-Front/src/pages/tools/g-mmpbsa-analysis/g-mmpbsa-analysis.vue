<template xmlns="http://www.w3.org/1999/html">
  <div>
    <div class="mag-step">
      <div style="font-weight: bold;margin: 0.5rem">g_mmpbsa_analysis
      ...
      <el-col :lg="24" :xl="12">
        <div class="mag-step-left">
          ...
          <div v-show="!isZip">
            ...
            <UpLoadFile FormatType=".xvg,.dat" UseType="g_mmpbsa_analysis" @GetIDList="GetFileID" :MaxSize="20"></UpLoadFile>
          </div>
        </div>
        <div class="mag-step-left">
    ...
    <el-drawer
      ...
      <excel-edit ModeName="g_mmpbsa_analysis" @HandleExcel="GetExcelData"/>
    </el-drawer>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        // info: info.g_mmpbsa_analysis,             //注释
    ...
    computed: {
      ...mapState({
        TaksID:state => state.TaskIDList.g_mmpbsa_analysis
      }),
    },
    watch: {
    ...
    methods: {
      ...
      RunGmmpbsa() {
        ...
        this.$api.GainGmmpbsaAnalysis(Params).then(res => {
          // console.log(res)
          this.$notify({
