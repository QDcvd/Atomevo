<template>
  <div>
    <div class="mag-step">
      <div style="font-weight: bold;margin: 0.5rem">Gmx
      ...
      <el-col :lg="24" :xl="12">
        <div class="mag-step-left">
          ...
          <div v-show="!isZip">
            ...
            <UpLoadFile FormatType=".xls,.csv,.xlsx," UseType="gmx" @GetIDList="GetFileID"></UpLoadFile>
          </div>
        </div>
        <div class="mag-step-left">
          <div>
            ...
            <el-button type="primary" size="small" @click="RunGmx"
    ...
    <el-drawer
      ...
      <excel-edit ModeName="Gmx" @HandleExcel="GetExcelData"/>
    </el-drawer>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        TaksID: state => state.TaskIDList.Gmx
      }),
      // RunSetMode() {
    ...
    methods: {
      ...
      RunGmx() {
        ...
        this.$api.GainGmx(data).then(res => {
          // console.log(res)
          this.$notify({
