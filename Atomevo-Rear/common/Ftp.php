...
class Ftp
{
    ...
    {   
        empty($config) ? $config = getConfig('ftp_config') : '';
...
// $local_file = './plants-test2-noxscore-allFile.zip';
// // var_dump(is_file($local_file));exit;
// $remote_file = 'plants/plants-test2-noxscore-allFile.zip';
