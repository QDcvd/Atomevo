...
class ledockV2
{
    ...
    public function run()
    {
        ...
        //检查任务唯一性
        $tasks_md5 = check_task($this->Db, $post, $uid, 'ledock', false);
        ...
        $msg_param = create_msg_param($uid, $token, 'ledock', $tasks_id);
        ...
        //运算检测
        if ($mode == 2) {
            $handle[] = './child/LedockLocal.php';
        } else {
            $handle[] = './child/ledock_xscoreV2.php';
        }
