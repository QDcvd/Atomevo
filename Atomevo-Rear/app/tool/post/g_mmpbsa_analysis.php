...
class g_mmpbsa_analysis
{
	...
	$tasks_md5 = $uid . '_' . md5(json_encode($post, 1) . '-' . __CLASS__); //任务MD5值
        ...
        //创建下载目录
        $out_path = '/data/wwwroot/mol/down/g_mmpbsa_analysis/' . $tasks_id . '/';
        ...
        //运算检测
        if ($mode == 2) {
            $handle[] = './child/g_mmpbsa_analysis_lcoal.php';
        } else {
            $handle[] = './child/g_mmpbsa_analysis.php';
        }
