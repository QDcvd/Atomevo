...
class mktop
{
    ...
    public function run()
    {
        ...
        foreach($file as $f){
            ...
            $out_file_name = getFileName($f['upload_name']) . '.top';
            $handle_child[] = "/data/binaryroot/mktop_2.2.1/mktop_2.2.1.pl -i '../input_file/{$f['upload_name']}' -o '{$out_file_name}' -ff amber -conect no";
        }
