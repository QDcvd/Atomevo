...
class trrosetta
{
    ...
    public function run()
    {
        ...
        // throw new Exception("抱歉 trrosetta 工具暂时无法使用");
        ...
        //创建目录
        $out_path = '/data/wwwroot/mol/down/trrosetta/' . $tasks_id . '/';
        $mk_dir[] = $out_path;
        ...
        if (!empty($ids) && $mode == 1) {
            ...
            if ($mode == 1) {
                ...
                rename($file, "/data/wwwroot/mol/down/trrosetta/{$tasks_id}/input_file/input.zip");
            }
        }
        ...
        if($mode ==1){
            $handle[] = './child/trrosetta_child.php';
        }else{
            $handle[] = './child/trrosettaLocal.php';
        }
