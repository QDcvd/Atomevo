...
class magicaltts
{
    ...
    public function run()
    {
        ...
        //创建目录
        $out_path = '/data/wwwroot/mol/down/magicaltts/' . $tasks_id . '/';
        $mk_dir[] = $out_path;
        ...
        foreach ($file as $key=>$value){
            ...
            $handle_child[] = "MPLBACKEND='Agg' /root/anaconda2/envs/pliptool/bin/python2.7 /data/pyroot/graphy/acpype.py -i ./input_file/{$value['upload_name']} -n X"; //acpype生成
        }
